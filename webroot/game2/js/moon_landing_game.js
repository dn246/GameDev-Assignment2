...
function preload() {
    game.load.image('moon_landing_background', 'assets/images/moon_landing_background.png');
    game.load.image('moon_set', 'assets/images/moon_landing_set.png');
    game.load.image('trash', 'assets/images/9_11_trash.png');
    game.load.spritesheet('player_walk', 'assets/images/cameraman_walk_cycle.png', 100,100,5);
}
...
function create() {
    ...
    backgrounds.create(0,0,'moon_landing_background');
    backgrounds.create(1334,0,'moon_landing_background');

    // Add the group of tables to the game
    tables = game.add.group();
    tables.create(0,200,'moon_set');
    tables.create(1334,200,'moon_set');

    // Set up player sprite and animation
    player = game.add.sprite (PLAYER_START_X,PLAYER_START_Y,'player_walk');
    player.animations.add('walk');
    player.animation.play('walk', 5, true);
