...
var notebook;
var select_9_11;
var select_moon_landing;
var select_weather_machine;
...
function create() {
    ...
    select_moon_landing = game.add.text(750, 375, 'The Moon Landing was staged', selectStyle);
    select_weather_machine = game.add.text(750, 425, 'RPI Weather Machine', selectStyle);
